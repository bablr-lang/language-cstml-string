...
export const grammar = class CSTMLStringGrammar {
  ...
  *String() {
    let q = yield _t.node("Instruction", "Call", [_t.ref`verb`, _t.ref`open`, _t.ref`argument`, _t.ref`close`], {
      verb: _t.node("Instruction", "Identifier", [_t.str`match`], {}),
      open: _t.node("Instruction", "Punctuator", [_t.str`(`], {}),
      argument: _t.node("Regex", "Pattern", [_t.ref`open`, _t.ref`[alternatives]`, _t.ref`close`], {
    ...
    if (!q) yield _t.node("Instruction", "Call", [_t.ref`verb`, _t.ref`open`, _t.ref`close`], {
      verb: _t.node("Instruction", "Identifier", [_t.str`fail`], {}),
      open: _t.node("Instruction", "Punctuator", [_t.str`(`], {}),
      close: _t.node("Instruction", "Punctuator", [_t.str`)`], {})
    });
    yield q === "'" ? _t.node("Instruction", "Call", [_t.ref`verb`, _t.ref`open`, _t.ref`argument`, _t.ref`close`], {
      verb: _t.node("Instruction", "Identifier", [_t.str`eat`], {}),
      open: _t.node("Instruction", "Punctuator", [_t.str`(`], {}),
      argument: _t.node("Spamex", "TokenMatcher", [_t.ref`open`, _t.trivia` `, _t.ref`type`, _t.trivia` `, _t.ref`value`, _t.trivia` `, _t.ref`[attributes]`, _t.trivia` `, _t.ref`[attributes]`, _t.trivia` `, _t.ref`close`], {
        ...
        attributes: [_t.node("Spamex", "StringAttribute", [_t.ref`key`, _t.ref`mapOperator`, _t.ref`value`], {
          key: _t.node("Spamex", "Literal", [_t.str`startSpan`], {}),
          mapOperator: _t.node("Spamex", "Punctuator", [_t.str`=`], {}),
          value: _t.node("Spamex", "String", [_t.ref`open`, _t.ref`value`, _t.ref`close`], {
            open: _t.node("Spamex", "Punctuator", [_t.str`'`], {}),
            value: _t.node("Spamex", "Literal", [_t.str`String`], {}),
            close: _t.node("Spamex", "Punctuator", [_t.str`'`], {})
          })
    ...
    yield q === "'" ? _t.node("Instruction", "Call", [_t.ref`verb`, _t.ref`open`, _t.ref`argument`, _t.ref`close`], {
      verb: _t.node("Instruction", "Identifier", [_t.str`eat`], {}),
      open: _t.node("Instruction", "Punctuator", [_t.str`(`], {}),
      argument: _t.node("Spamex", "TokenMatcher", [_t.ref`open`, _t.trivia` `, _t.ref`type`, _t.trivia` `, _t.ref`value`, _t.trivia` `, _t.ref`[attributes]`, _t.trivia` `, _t.ref`close`], {
        open: _t.node("Spamex", "Punctuator", [_t.str`<|`], {}),
        type: _t.node("Spamex", "Identifier", [_t.str`Punctuator`], {}),
        value: _t.node("Spamex", "String", [_t.ref`open`, _t.ref`value`, _t.ref`close`], {
          open: _t.node("Spamex", "Punctuator", [_t.str`"`], {}),
